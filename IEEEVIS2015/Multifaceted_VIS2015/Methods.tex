...
\begin{equation*}
i_{best} = \displaystyle \argmax_{i\in I}[Pr(g|i)\cdot Pr(i)]
\end{equation*}
...
%\begin{table}[htbp]
	%\centering
		%\begin{tabular}{|c|c|c|c|c|}
			%\hline
			 %\multicolumn{2}{ |l| }{Actor to}  &\shortstack{	No. of  \\ Transitions} 	&\shortstack{transition \\ prob.}	&\shortstack{	adjusted \\ transition \\ prob.}\\ \hline
       %\multirow{2}{*}{Actor}	&-	&1905	&0.515	&0.033	\\	\cline{2-5}
															%&H	&890	&0.24	&0.369	\\	\hline
				%\multirow{4}{*}{Movie}	&-	&392	&0.106	&0.037	\\	\cline{2-5}
															%&H	&125	&0.034	&0.15	\\	\cline{2-5}
															%&C	&152	&0.041	&0.158	\\	\cline{2-5}
															%&CH	&153	&0.041	&0.199	\\	\hline
				%\multirow{2}{*}{Director}	&-	&33	&0.009	&0.004	\\	\cline{2-5}
															%&H	&8	&0.002	&0.022	\\	\hline
				%\multirow{2}{*}{Genre}	&-	&24	&0.006	&0.002	\\	\cline{2-5}
															%&H	&20	&0.005	&0.025	\\	\hline
					%\multicolumn{2}{ |l| }{Total}	&3702	&1	&1	\\	
	%\hline
		%\end{tabular}
	%\caption{Transitions from Actors}
...
%\begin{table}[htbp]
	%\centering
		%\begin{tabular}{|c|c|c|c|c|}
			%\hline
			 %\multicolumn{2}{ |l| }{Director to}  &\shortstack{	No. of  \\ Transitions} 	&\shortstack{transition \\ prob.}	&\shortstack{	adjusted \\ transition \\ prob.}\\ \hline
       %\multirow{2}{*}{Actor}	&-	&25	&0.037	&0.001	\\	\cline{2-5}
															%&H	&10	&0.015	&0.01	\\	\hline
				%\multirow{4}{*}{Movie}	&-	&106	&0.156	&0.031	\\	\cline{2-5}
																%&H	&23	&0.034	&0.132	\\	\cline{2-5}
																%&C	&44	&0.065	&0.086	\\	\cline{2-5}
																%&CH	&25	&0.037	&0.144	\\	\hline
				%\multirow{2}{*}{Director}	&-	&166	&0.245	&0.06	\\	\cline{2-5}
																	%&H	&65	&0.096	&0.311	\\	\hline
				%\multirow{2}{*}{Genre}	&-	&117	&0.173	&0.032	\\	\cline{2-5}
																%&H	&97	&0.143	&0.193	\\ \hline
																%\multicolumn{2}{ |l| }{Total}	&678	&1	&1	\\
%
				 %\hline
		%\end{tabular}
	%\caption{Transitions from Directors}
...
%\begin{table}[htbp]
	%\centering
		%\begin{tabular}{|c|c|c|c|c|}
			%\hline
			 %\multicolumn{2}{ |l| }{Genre to}  &\shortstack{	No. of  \\ Transitions} 	&\shortstack{transition \\ prob.}	&\shortstack{	adjusted \\ transition \\ prob.}\\ \hline
       %\multirow{2}{*}{Actor}	&-	&41	&0.048	&0.001	\\	\cline{2-5}
															%&H	&10	&0.012	&0.009	\\	\hline
				%\multirow{4}{*}{Movie}	&-	&111	&0.129	&0.014	\\	\cline{2-5}
																%&H	&18	&0.021	&0.065	\\	\cline{2-5}
																%&C	&76	&0.088	&0.027	\\	\cline{2-5}
																%&CH	&62	&0.072	&0.137	\\	\hline
				%\multirow{2}{*}{Director}	&-	&115	&0.134	&0.016	\\	\cline{2-5}
																	%&H	&77	&0.09	&0.413	\\	\hline
				%\multirow{2}{*}{Genre}	&-	&151	&0.176	&0.014	\\	\cline{2-5}
																%&H	&199	&0.231	&0.304	\\	\cline{2-5}
					%\multicolumn{2}{ |l| }{Total}	&860	&1	&1	\\	
	%\hline
		%\end{tabular}
	%\caption{Transitions From Genres}
