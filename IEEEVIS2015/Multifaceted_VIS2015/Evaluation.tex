...
\begin{table}[htbp]	
	\centering
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			 \multicolumn{2}{ |c| }{Movie to}  &\shortstack{No. of\\transitions} 	&\shortstack{ Raw\\transition\\probability }	&\shortstack{	 Real\\transition\\probability}\\ \hline
      \multirow{4}{*}{Actor}	&-	&793	&0.076	&0.004	\\	\cline{2-5}
				...
				\multirow{4}{*}{Genre}	&-	&193	&0.018	&0.005	\\	\cline{2-5}
					...
					\multicolumn{2}{ |c| }{Total}	&10459	&1	&1	\\		
				\hline
		\end{tabular}		
		...
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			 \multicolumn{2}{ |c| }{Actor to}   &\shortstack{No. of\\transitions} 	&\shortstack{ Raw\\transition\\probability }	&\shortstack{	 Real\\transition\\probability}\\ \hline
						 \multirow{2}{*}{Actor}	&-	&4711	&0.533	&0.032	\\	\cline{2-5}
							...
							\multirow{2}{*}{Genre}	&-	&43	&0.005	&0.002	\\	\cline{2-5}
								...
								\multicolumn{2}{ |c| }{Total}	&8844	&1	&1	\\	
	\hline
	...
	\begin{tabular}{|c|c|c|c|c|}
			\hline
			 \multicolumn{2}{ |c| }{Director to}   &\shortstack{No. of\\transitions} 	&\shortstack{ Raw\\transition\\probability }	&\shortstack{	 Real\\transition\\probability}\\ \hline
       \multirow{2}{*}{Actor}	&-	&71	&0.042	&0.001	\\	\cline{2-5}
			...
			\multirow{2}{*}{Genre}	&-	&256	&0.153	&0.026	\\	\cline{2-5}
				...
				\multicolumn{2}{ |c| }{Total}	&1678	&1	&1	\\	
				\hline
		\end{tabular}
		...
		\begin{tabular}{|c|c|c|c|c|}
			\hline
			 \multicolumn{2}{ |c| }{Genre to}   &\shortstack{No. of\\transitions} 	&\shortstack{ Raw\\transition\\probability }	&\shortstack{	 Real\\transition\\probability}\\ \hline
       \multirow{2}{*}{Actor}	&-	&61	&0.03	&0	\\	\cline{2-5}
				...
				\multirow{2}{*}{Genre}	&-	&348	&0.172	&0.013	\\	\cline{2-5}
					...
					\multicolumn{2}{ |c| }{Total}	&2029	&1	&1	\\	
			\hline
		\end{tabular}
